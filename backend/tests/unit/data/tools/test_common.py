...
@pytest.mark.parametrize("obj, expected, should_raise", [
...
@pytest.mark.parametrize("date_str, fmt, expected, should_raise", [
...
@pytest.mark.parametrize("content, expected, should_be_none", [
    # 1. Valid JSON object
...
@pytest.mark.parametrize("data, expected_keys, should_succeed", [
    # 1. Simple dict
